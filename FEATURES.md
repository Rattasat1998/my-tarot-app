...
### 2026-01-30
- ย้าย Daily Login จาก auto-popup มาเป็นปุ่มในเมนูหลัก (`MenuState.jsx`, `GamePage.jsx`)
- ปิดระบบเติมเงินชั่วคราว (ซ่อนปุ่มใน `Navbar.jsx`)
- ปรับ daily check-in: 1 เครดิต/วัน, 3 เครดิตวันที่ 7 (`DailyRewardModal.jsx`)
- ทำให้ daily free draw อัตโนมัติ ไม่ต้องกดรับ (`useCredits.js`)
