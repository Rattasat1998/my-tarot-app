...
export function GamePage({ isDark, setIsDark }) {
    usePageSEO({
        title: 'ดูดวงออนไลน์ฟรี 2569 | ไพ่ทาโรต์แม่นๆ ดวงความรัก การงาน การเงิน',
        description: 'ดูดวงออนไลน์ฟรี ดูดวงไพ่ทาโรต์แม่นที่สุด 2569 เปิดไพ่ทาโรต์ 78 ใบ ดูดวงความรัก ดูดวงการงาน ดูดวงการเงิน ดวงสุขภาพ ดวง 12 ราศี คำพยากรณ์รายวัน ดูดวงเนื้อคู่ ดูดวงรูน วิเคราะห์หวย เลขเด็ด',
        keywords: 'ดูดวง, ดูดวงออนไลน์, ดูดวงฟรี, ดูดวงไพ่ทาโรต์, ไพ่ทาโรต์, ดูดวงความรัก, ดูดวงการงาน, ดูดวงการเงิน, ดวงวันนี้, ดวงรายวัน, ดวง 12 ราศี, ดูดวงแม่นๆ, ไพ่ยิปซี, ดูดวงเนื้อคู่, ดูดวง 2569, ทำนายดวง',
