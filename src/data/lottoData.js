...
export const LOTTO_DRAWS = [
    {
        ...
        historical: {
            labels: ['87', '60', '99', '06', '22'],
            data: [2, 1, 1, 1, 1],
            context: 'สถิติย้อนหลังงวด 16 พ.ค. + เลขชนกระแสประจำงวด'
        },
        historical_stats: [
            { year: '2568', first: '251309', lastTwo: '87', front3: ['109', '231'], back3: ['965', '631'] },
            { year: '2567', first: '205690', lastTwo: '60', front3: ['885', '747'], back3: ['137', '070'] },
            { year: '2566', first: '132903', lastTwo: '99', front3: ['678', '739'], back3: ['693', '731'] },
            { year: '2565', first: '155012', lastTwo: '06', front3: ['247', '736'], back3: ['236', '540'] },
            { year: '2564', first: '684579', lastTwo: '14', front3: ['843', '615'], back3: ['276', '970'] },
            { year: '2563', first: '051095', lastTwo: '22', front3: ['285', '430'], back3: ['191', '364'] },
            { year: '2562', first: '962526', lastTwo: '71', front3: ['949', '669'], back3: ['828', '018'] },
        ],
        sources: [
            {
                name: 'สยามนิวส์ เลขศาสตร์',
                theme: 'เน้น 69 / 87 / 25',
                color: 'green',
                numbers: ['6', '9', '8', '7', '2', '5'],
                two: ['69', '87', '25', '10', '38', '52'],
                three: ['789', '124', '560'],
                numberHot: '69'
            },
            {
                name: 'ม้าสีหมอก',
                theme: 'บน 4-7 ล่าง 1-5',
                color: 'pink',
                numbers: ['4', '7', '1', '5', '6', '8'],
                two: ['04', '64', '07', '67', '16', '18', '56', '58'],
                three: ['164', '467', '158'],
                numberHot: '4'
            },
            {
                ...
                color: 'blue',
                numbers: ['8', '5', '6', '3', '9', '4'],
                two: ['86', '58', '53', '89', '45', '88', '38', '69'],
                three: ['486', '358', '953', '589', '145'],
                numberHot: '8'
            },
            {
                name: 'ปฏิทินหลวงปู่ศิลา',
                theme: 'ชุด 5-3-4-1-2',
                color: 'green',
                numbers: ['5', '3', '4', '1', '2'],
                two: ['53', '54', '51', '52', '32', '25'],
                three: ['532', '142', '435', '251', '325'],
                numberHot: '5'
            }
        ],
        trends: {
            labels: ['เลขชนหลายแหล่ง (58/69/38)', 'เลขวันหวยออก (16/61)', 'เลขปีและเดือน (69/05)', 'อื่นๆ'],
            data: [42, 27, 21, 10],
            colors: ['#ef4444', '#f97316', '#eab308', '#9ca3af'],
            items: [
                { label: '🔥 เลขชนหลายแหล่ง (58, 69, 38)', rank: 1 },
                { label: '📅 เลขวันเสาร์กลางเดือน (16, 61)', rank: 2 },
                { label: '✨ เลขสถิติงวด 16 พ.ค. เด่น (87, 60)', rank: 3 }
            ]
        },
        events: [
            {
                icon: '📅',
                title: 'งวดวันเสาร์ 16 พฤษภาคม 2569',
                details: [
                ...
                hotNumbers: ['16', '61', '05', '50', '69', '96', '07']
            },
            {
                icon: '🐎',
                title: 'กระแสม้าสีหมอก',
                details: [
                    { label: 'เด่นบน', value: '4, 7' },
                    { label: 'วิ่งบน', value: '4' },
                    { label: 'เด่นล่าง', value: '1, 5' },
                    { label: 'วิ่งล่าง', value: '1' }
                ],
                hotNumbers: ['04', '64', '07', '67', '16', '58']
            },
            {
                icon: '✨',
                title: 'เลขศาสตร์และทักษามหาโชค',
                details: [
                    { label: 'เลขเด่น', value: '8' },
                    { label: 'เลขรอง', value: '5' },
                    { label: 'เลขชน', value: '58, 69, 38' }
                ],
                hotNumbers: ['58', '69', '38', '86', '89', '53']
            }
        ],
        horoscope: {
            year: {
                ...
                luckyNumbers: ['8', '5', '1'],
                balanceNumber: '6',
                relatedPairs: ['58', '85', '16', '61', '69', '96']
            },
            chineseCalendar: {
                verticalNumbers: ['1', '6', '5', '8'],
                twoPairs: ['16', '61', '58', '85', '69', '96'],
                threePairs: ['165', '516', '568', '869', '158']
            }
        },
        sunday_stats: {
            title: 'สถิติหวยออกวันเสาร์',
            note: 'วันที่ 16 พฤษภาคม 2569 ตรงกับวันเสาร์ จึงให้น้ำหนักเลข 7, เลขกลางเดือน 16 และเลขชนสำนัก 58/69',
            lastTwo: [
                { count: 1, numbers: ['87', '60', '99', '06', '14', '22', '71'] }
            ],
            firstTwoFromFirst: [
                { count: 1, numbers: ['25', '20', '13', '15', '68', '05', '96'] }
            ],
            dominantDigits: ['8', '5', '6', '9']
        },
        vip_numbers: [
            { name: 'เลขวันวิสาขบูชา', event: 'วันพระใหญ่เดือนพฤษภาคม', anniversary: '11 พ.ค. 2569', numbers: ['11', '51', '15'] },
            { name: 'เลขวันฉัตรมงคล', event: 'วันสำคัญต้นเดือน', anniversary: '4 พ.ค. 2569', numbers: ['04', '40', '69'] },
            { name: 'เลขวันแรงงาน', event: 'วันหยุดต้นเดือน', anniversary: '1 พ.ค. 2569', numbers: ['01', '10', '51'] }
        ],
        luckyPool: [
            '58', '58', '58', '58',
            '69', '69', '87', '87',
        ...
        conclusion: {
            statistical: {
                ...
                icon: '📊',
                numbers: [
                    { num: '87', reason: 'เลขท้าย 2 ตัวของงวด 16 พ.ค. 2568 และยังชนกับเลขศาสตร์งวดนี้' },
                    { num: '60', reason: 'เลขท้าย 2 ตัวของงวด 16 พ.ค. 2567 ใช้เป็นเลขรองเชิงสถิติ' },
                    { num: '16', reason: 'เลขวันออกรางวัลกลางเดือน และสัมพันธ์กับชุดกลับ 61' }
                ]
            },
            eventDriven: {
                ...
                icon: '🔥',
                numbers: [
                    { num: '58', reason: 'ชนจากม้าสีหมอกและทักษามหาโชค เป็นแกนหลักของงวดนี้' },
                    { num: '69', reason: 'เลขปี พ.ศ. 2569 และชนกับเลขศาสตร์/ทักษามหาโชค' },
                    { num: '38', reason: 'เลขชนจากชุดเลขศาสตร์และทักษามหาโชค เหมาะเป็นเลขรอง' }
                ]
            },
            consensus: {
                ...
                icon: '🤝',
                numbers: [
                    { num: '8', reason: 'เป็นเลขเด่นในทักษามหาโชค และปรากฏในหลายชุด 2/3 ตัว' },
                    { num: '5', reason: 'เป็นเลขรองทักษามหาโชคและแกนปฏิทินหลวงปู่ศิลา' },
                    { num: '58', reason: 'คู่เลขที่ชนชัดที่สุดระหว่างเลขล่างและชุดทักษา' }
                ]
            },
            finalPicks: {
                twoDigit: ['58', '69', '87', '16', '38', '04'],
                threeDigit: ['358', '789', '532', '486', '068']
            }
        }
    },
