            ...
            <div className="relative w-full max-w-md bg-gradient-to-b from-slate-900 to-slate-950 border border-slate-700/50 rounded-2xl shadow-2xl shadow-purple-500/10 overflow-hidden animate-in fade-in zoom-in-95 duration-300">
                ...
                <div className="relative p-6 pb-4 border-b border-slate-800">
                    <div className="flex items-center justify-between">
                        <div />
                        <h2 className="text-xl font-serif font-bold text-white">เข้าสู่ระบบ</h2>
                        <button
                            onClick={onClose}
                ...
                <div className="p-6 space-y-4">
                    ...
                    <button
                        ...
                        className="w-full flex items-center justify-center gap-3 px-4 py-3.5 rounded-xl bg-[#06C755] text-white font-bold text-sm hover:bg-[#05b34c] transition-all shadow-lg shadow-green-500/20"
                    >
